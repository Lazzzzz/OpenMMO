...
val POKEMMO_FEED_URLS: List<Pair<String, FeedFile>> =
    listOf(
            "https://dl.pokemmo.com" to setOf(FeedFile.MAIN, FeedFile.SIGNATURE, FeedFile.NEWS),
            "https://files.pokemmo.com" to setOf(FeedFile.MAIN, FeedFile.SIGNATURE, FeedFile.NEWS),
            "https://dl.pokemmo.eu" to setOf(FeedFile.MAIN, FeedFile.SIGNATURE),
            "https://files.pokemmo.eu" to setOf(FeedFile.MAIN, FeedFile.SIGNATURE),
            "https://dl.pokemmo.download" to setOf(FeedFile.MAIN, FeedFile.SIGNATURE),
        )
        .flatMap { (origin, files) -> files.map { origin + it.pokemmoPath to it } }
